<?php
	$titulo="Nuevo Producto de la Colección Hombre";
	$seccion="hombre";
		...
		if( isset($_POST['articulo']) && isset($_POST['descripcion'])) {
			...
			if ($articulo != "" && strlen($descripcion)>0 ) {
				if ( !$problemaImagenGrande) {
					...
					$query = "INSERT INTO productos (articulo, descripcion, foto, coleccion, visible, novedad, orderBy, borrado) VALUES ( $articulo, '$descripcion', '$imagen', 'Hombre', $visible, $novedad, $orderBy, 0 )";
