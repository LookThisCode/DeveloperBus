<?php
	...
	$seccion="canchas";
	$funcionValidacion = "formValidationCancha"; //HACER ESTE FORMVALIDATION
	$hayImagenes = true;
...
<div id="wrapper" style="width:500px;">
	...
	<?php 
		...
		$query = "SELECT * FROM canchas WHERE borrado=0 AND id=". $id;
		...
		$old_novedad = $row['novedad']; //actualizar esto
		...
		if( isset($_POST['articulo']) && isset($_POST['descripcion'])) {
			...
			postBool("novedad",$novedad);			 //actualizar esto
