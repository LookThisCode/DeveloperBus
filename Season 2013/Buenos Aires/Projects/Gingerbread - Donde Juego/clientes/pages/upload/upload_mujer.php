<?php
	$titulo="Nuevo Producto de la Colección Mujer";
	$seccion="mujer";
		...
		if( isset($_POST['articulo']) && isset($_POST['descripcion'])) {
			...
			if ($articulo != "" && strlen($descripcion)>0 ) {
				if ( !$problemaImagenGrande) {
					...
					$query = "INSERT INTO productos (articulo, descripcion, foto, coleccion, visible, novedad, orderBy, borrado) VALUES ( $articulo, '$descripcion', '$imagen', 'Mujer', $visible, $novedad, $orderBy, 0 )";
