...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/table.2.css" type="text/css">
<style type="text/css">
input[type=text] {
	background: white;
...
<div class="card productos" style="position: absolute;">
	<img alt="productos" src="${pageContext.request.contextPath}/img/productos-icon.png"><br />
	<span style="color: #ddd">Productos</span>
</div>

<form action="products.mvc" method="post" id="formulario">
<div class="table">
	<div class="row">
