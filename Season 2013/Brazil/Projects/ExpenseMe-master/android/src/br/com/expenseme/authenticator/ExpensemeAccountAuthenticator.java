...
import static br.com.expenseme.authenticator.ExpensemeAuthenticatorActivity.PARAM_AUTHTOKEN_TYPE;
...
class ExpensemeAccountAuthenticator extends AbstractAccountAuthenticator {

    private static final String DESCRIPTION_CLIENT = "Bootstrap for Android";

    private final Context context;

    public ExpensemeAccountAuthenticator(Context context) {
        super(context);
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType,
        ...
        final Intent intent = new Intent(context, ExpensemeAuthenticatorActivity.class);
     ...
     * {@link br.com.expenseme.authenticator.ApiKeyProvider#getAuthKey()} methods gets invoked.
